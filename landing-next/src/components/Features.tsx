...
const features = [
  ...
  },
  {
    ...
    description: "Access all 180 skills while using under 7% of your context window. Skills load on-demand, so your context stays free for actual work.",
    highlight: false,
  },
  {
    number: "03",
    icon: Puzzle,
    title: "37 MCP plugins",
